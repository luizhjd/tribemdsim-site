          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <img src={logoipsum1} alt="Logo 1" className="h-6 opacity-60" />
                <img src={logoipsum2} alt="Logo 2" className="h-6 opacity-60" />
                <img src={logoipsum3} alt="Logo 3" className="h-6 opacity-60" />
                <img src={logoipsum4} alt="Logo 4" className="h-6 opacity-60" />
                <img src={logoipsum5} alt="Logo 5" className="h-6 opacity-60" />
                <img src={logoipsum6} alt="Logo 6" className="h-6 opacity-60" />
              </div>
            </div>
          </motion.div>
